...
public class Exemple {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out
				.println("Demande modifiée par l'élève : " + dvctap.getEtat());

		dvctap.valideeParLeProfesseur();
		System.out.println("Demande validée par le professeur : "
				+ dvctap.getEtat());
		...
		dvctap.setEtat(2048);
		System.out.println("Durée modifiée par le professeur : "
				+ dvctap.getEtat());
